...
const pricingList = [
    {
        name1: '01',
        title1: 'Bus Fare',
        info1: <p className='text-grey text-manrope text-[1rem]'>Every ride starts with a minimal base fare of <span className='font-bold text-black'>KES 50</span>, ensuring our electric motorbikes are charged, primed, and ready to go!</p>,

        name2: '02',
        title2: 'Eco-Savings',
        info2: <p className='text-grey font-manrope text-[1rem]'>Choose KASI, choose the planet! By using our green electric motorbikes, not only are you <span className='font-bold text-black'>reducing your carbon footprint</span>, but we also pass on our fuel savings to you. It’s a win-win!</p>
    },
    {
        name1: '03',
        title1: 'Distance-Driven Rates',
        // eslint-disable-next-line react/no-unescaped-entities
        info1: <p className='text-grey font-manrope text-[1rem]'>Simply put, you pay <span className='font-bold text-black'>100 bob</span> for <span className='font-bold text-black'>every kilometer</span> we cover. No hidden fees, no surprises. The longer the ride, the more you'll know exactly where your money's going.</p>,

        name2: '04',
        title2: 'Time-based Charges',
        info2: <p className='text-grey font-manrope text-[1rem]'>Waiting in traffic? Don’t worry! Our charges take into account the time spent on the road, so you’re <span className='font-bold text-black'>never unfairly charged</span> for those unforeseen delays.</p>
    },
    {
        name1: '05',
        title1: 'Dynamic Discounts',
        info1: <p className='text-grey font-manrope text-[1rem]'>Keep an eye out for <span className='font-bold text-black'>seasonal offers, loyalty rewards, and special promotions</span>. We love to give back to our dedicated users!</p>,

        name2: '06',
        title2: 'Peak Time Indicators',
        // eslint-disable-next-line react/no-unescaped-entities
        info2: <p className='text-grey font-manrope text-[1rem]'>We believe in <span className='font-bold text-black'>transparency</span>. If it’s a particularly busy time and rates are a tad higher, we'll always let you know in advance. No guessing games here!</p>
    },
    {
        name1: '07',
        title1: 'Service Fee',
                            ...
                            return (
                                <div key={index} className='flex flex-col gap-[3.5rem]'>
                                    <div className='flex flex-col justify-center gap-[1rem]'>
                                        <p className='font-bold text-[1.8rem] text-green font-space self-start'>{item.name1}</p>
                                        <div className='flex flex-col gap-2'>
                                            <p className='font-base text-[1.4rem] font-bold'>{item.title1}</p>
                                            {item.info1}
                                        </div>
                                    </div>

                                    <div className='flex flex-col justify-center gap-[1rem]'>
                                        <p className='font-bold text-[1.8rem] text-green font-space self-start'>{item.name2}</p>
                                        <div className='flex flex-col gap-2'>
                                            <p className='font-base text-[1.4rem] font-bold'>{item.title2}</p>
                                            {item.info2}
                                        </div>
                                    </div>
