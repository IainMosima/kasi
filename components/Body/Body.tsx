    ...
    <main className='w-full flex flex-col place-items-center gap-[4.1rem]'>
        ...
        <div className='grid lg:grid-cols-4 grid-cols-8 sm:gap-x-[4rem] gap-y-[3rem] w-full gap-x-[1rem] justify-items-end'>
          {partners.map(partner => (
            <div key={partner.name} className='grid h-auto auto-rows-auto'>
              ...
              <p className='sm:text-[1.3rem] text-sm sm:leading-7 leading-5 font-base font-normal text-grey'>{partner.name}</p>
            </div>
          ))}
        </div>
      ...
      <div className='flex gap-[4rem] w-full flex-col'>
        ...
        <div className='flex w-full flex-col gap-2 justify-start'>
          ...
          <div className='grid sm:grid-cols-3 place-items-start justify-start gap-2'>
            <h4 className='tracking-wide self-center text-[1.9rem]'>Orders Per Month</h4>
            <p className='text-grey text-left text-[1.3rem] sm:place-self-center'>Our commitment to seamless logistics and dedicated service consistently results in high order volumes month after month, showcasing our reliability and excellence in meeting your needs.</p>
        ...
        <div className='flex w-full flex-col gap-2 justify-start'>
          <hr className=' border-t-2 border-gray rounded-full w-full' />
          <div className='grid sm:grid-cols-3 place-items-start justify-start gap-2'>
            <h4 className='tracking-wide self-center text-[1.9rem]'>Average Delivery Time</h4>
            <p className='text-grey text-left text-[1.3rem] sm:place-self-center'>Our dedicated team consistently achieves swift delivery times, ensuring your deliveries reach their destinations promptly. We understand the importance of timely deliveries, and we make it our mission to exceed your expectations.</p>
        ...
        <div className='flex w-full flex-col gap-2 justify-start'>
          <hr className=' border-t-2 border-gray rounded-full w-full' />
          <div className='grid sm:grid-cols-3 place-items-start justify-start gap-2'>
            <h4 className='tracking-wide self-center text-[1.9rem]'>Customer Services Rating</h4>
            <p className='text-grey text-left text-[1.3rem] sm:place-self-center'>Our commitment to excellence extends to every aspect
      ...
      <div className='flex lg:flex-row flex-col w-full gap-6 lg:gap-[10rem]'>
        <div className='flex flex-col lg:flex-col gap-2 basis-[40%] md:flex-row md:justify-between lg:justify-center w-full'>
          ...
          <p className='text-left text-[1.3rem] font-manrope font-normal md:basis-[50%]'>{`At KASI, our ethos is grounded in reliability, innovation, and a steadfast dedication to our clients' success. We believe in going the extra mile, ensuring that your deliveriesreach you safely and efficiently.`}</p>
        </div>
      ...
      <div className='flex lg:flex-row flex-col w-full gap-6 lg:gap-[10rem]'>
        <div className='flex flex-col lg:flex-col gap-2 basis-[40%] md:flex-row md:justify-between lg:justify-center w-full'>
          ...
          <p className='text-left text-[1.3rem] leading-7 font-manrope font-normal md:basis-[50%]'>At KASI Logistics, our core values drive every decision and action. We prioritize transparency, sustainability, and exceeding expectations, fostering lasting relationships with our clients and partners</p>
        </div>
          ...
          <Link href='/sign-up' className='col-span-3 '>
            <div className=' grid gap-2 w-full h-full border-[#F2F2F2] bg-green'>
              ...
              <div className='flex w-full flex-col p-3 gap-3 justify-between'>
                <p className='text-white font-base font-bold text-[1.5rem]'>Sign up with KASI and meet your Delivery Targets easily.</p>
      ...
      <div className='w-full bg-orange '>
        <div className='w-full relative lg:px-[7.5rem] md:px-[4rem] lg:py-[7rem] md:py-[2rem] px-3 py-5'>
          <p className='text-white lg:text-[2.7rem] md:text-[2.1rem] text-[1.4rem] text-left  font-normal font-base'>{`Brands collaborating with KASI are not just accessing a reliable logistics partner, they're making a conscious choice to support sustainability, innovation, and the future of eco-friendly transportation. This alignment not only boosts the brand's image but also ensures that they're part of the global solution to environmental challenges.`}</p>
      ...
      <div className='flex flex-col gap-[2rem] w-full'>
        ...
        <div className='hidden md:grid lg:grid-cols-3 md:grid-cols-2 w-full place-items-center gap-x-[2rem] gap-y-[2.4rem]'>
          ...
          <div className='lg:col-span-1 flex flex-col p-2 h-full'>
            <p className='font-base text-[1.9rem]  w-[10%] font-bold basis-[50%]'>Environmental Benefits</p>
            <p className='font-base text-[1.6rem] font-semibold'>Reduced Carbon Footprint</p>
            <p className='font-base text-[1.4rem] text-manrope text-grey'>{`Electric motorbikes produce zero direct emissions. This means they contribute significantly less to greenhouse gas emissions compared to traditional gasoline powered vehicles.`}</p>
            <p className='font-base text-[1.5rem] font-semibold'>Noise Pollution</p>
            <p className='font-base text-[1.4rem] text-manrope text-grey'>{`Electric motorbikes operate at a significantly lower noise level, reducing noise pollution in urban areas.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>01</p>
          </div>
          ...
          <div className='lg:col-span-1 flex flex-col p-2 h-full'>
            <p className='font-base text-[1.9rem]  w-[10%] font-bold basis-[50%]'>Operational Efficiency</p>
            <p className='font-base text-[1.6rem] font-semibold'>Lower Operational Costs</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Electric motorbikes generally have fewer moving parts than their gasoline counterparts, leading to less wear and tear and reduced maintenance costs. Additionally, electricity is often cheaper than gasoline, leading to cost savings in refueling.`}</p>
            <p className='font-base text-[1.6rem] font-semibold'>Noise Quick and Nimble</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Their compact size and agility make electric motorbikes perfect for navigating through congested city streets, ensuring quicker deliveries.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>02</p>
          </div>


          {/* Public Perception and Branding */}
          <div className='lg:col-span-1 flex flex-col p-2 h-full'>
            <p className='font-base text-[1.9rem] w-[50%] font-bold basis-[50%]'>Public Perception and Branding</p>
            <p className='font-base text-[1.6rem] font-semibold'>Sustainability Image</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Brands that align themselves with environmentally-conscious partners like KASI will be perceived as more responsible and sustainable. This can be a significant competitive advantage in markets where consumers are becoming increasingly eco-aware.`}</p>
            <p className='font-base text-[1.5rem] font-semibold'>Supporting Innovation</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`By supporting a company that employs electric motorbikes, brands position themselves as champions of innovative and sustainable solutions.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>03</p>
          </div>
          ...
          <div className='lg:col-span-1 flex flex-col p-2 h-full'>
            <p className='font-base text-[1.9rem]  w-[10%] font-bold basis-[50%]'>Economic Implications</p>
            <p className='font-base text-[1.6rem] font-semibold'>Supporting Green Tech</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Investing in electric motorbikes indirectly supports the broader green technology sector, driving further advancements and innovations in sustainable transportation.`}</p>
            <p className='font-base text-[1.6rem] font-semibold'>Fuel Independence</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`By not relying on volatile oil markets, KASI can maintain more consistent operational costs,benefiting both the company and its clients.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>04</p>
          </div>

          {/* Future-proofing */}
          <div className='lg:col-span-1 flex flex-col p-2 h-full'>
            <p className='font-base text-[1.9rem]  w-[40%] font-bold basis-[70%]'>Future-proofing</p>
            <p className='font-base text-[1.6rem] font-semibold'>Regulation Ready</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Many cities around the world are introducing stricter emissions regulations or outright bans on gasoline-powered vehicles in certain zones. By using electric motorbikes, KASI is well-prepared for such future regulatory changes, ensuring uninterrupted service.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>05</p>
          </div>
        ...
        <div className='w-full grid sm:hidden place-items-center lg:grid-cols-3 md:grid-cols-2 gap-x-[1.6rem] gap-y-[2.4rem]'>
          {/* Environmental benefits */}
          <div className='lg:col-span-1 flex flex-col p-2 h-full gap-6'>
            <p className='font-base text-[1.9rem] font-bold mb-5'>Environmental Benefits</p>
            <p className='font-base text-[1.6rem] font-semibold'>Reduced Carbon Footprint</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Electric motorbikes produce zero direct emissions. This means they contribute significantly less to greenhouse gas emissions compared to traditional gasoline powered vehicles.`}</p>
            <p className='font-base text-[1.6rem] font-semibold'>Noise Pollution</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Electric motorbikes operate at a significantly lower noise level, reducing noise pollution in urban areas.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>01</p>
          </div>
          <Image src={Images.motorcycle} className='lg:col-span-2 place-self-center' priority={true} alt='motorcycle ' />
          ...
          {/* Operational Efficiency */}
          <div className='lg:col-span-1 flex flex-col p-2 h-full gap-6'>
            <p className='font-base text-[1.9rem] font-bold mb-5'>Operational Efficiency</p>
            <p className='font-base text-[1.6rem] font-semibold'>Lower Operational Costs</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Electric motorbikes generally have fewer moving parts than their gasoline counterparts, leading to less wear and tear and reduced maintenance costs. Additionally, electricity is often cheaper than gasoline, leading to cost savings in refueling.`}</p>
            <p className='font-base text-[1.6rem] font-semibold'>Noise Quick and Nimble</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Their compact size and agility make electric motorbikes perfect for navigating through congested city streets, ensuring quicker deliveries.`}</p>
          ...
          {/* Public Perception and Branding */}
          <div className='lg:col-span-1 flex flex-col p-2 h-full gap-6'>
            <p className='font-base text-[1.9rem] font-bold mb-5'>Public Perception and Branding</p>
            <p className='font-base text-[1.6rem] font-semibold'>Sustainability Image</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Brands that align themselves with environmentally-conscious partners like KASI will be perceived as more responsible and sustainable. This can be a significant competitive advantage in markets where consumers are becoming increasingly eco-aware.`}</p>
            <p className='font-base text-[1.6rem] font-semibold'>Supporting Innovation</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`By supporting a company that employs electric motorbikes, brands position themselves as champions of innovative and sustainable solutions.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>03</p>
          </div>
          <Image src={Images.delivery3} className='lg:col-span-2 place-self-center' priority={true} alt='delivery' />
          ...
          {/* Economic Implications */}
          <div className='lg:col-span-1 flex flex-col p-2 h-full gap-6'>
            <p className='font-base text-[1.9rem] font-bold mb-5'>Economic Implications</p>
          ...
          {/* Future-proofing */}
          <div className='lg:col-span-1 flex flex-col p-2 h-full gap-6'>
            <p className='font-base text-[1.9rem] font-bold mb-5'>Future-proofing</p>
            <p className='font-base text-[1.6rem] font-semibold'>Regulation Ready</p>
            <p className='font-base text-[1.5rem] text-manrope text-grey'>{`Many cities around the world are introducing stricter emissions regulations or outright bans on gasoline-powered vehicles in certain zones. By using electric motorbikes, KASI is well-prepared for such future regulatory changes, ensuring uninterrupted service.`}</p>
            <p className='font-bold text-[1.9rem] font-space self-end'>05</p>
          </div>
