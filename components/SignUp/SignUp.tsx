    ...
    return (
        <main className='w-full flex flex-col gap-[4.1rem]'>
            ...
            <div className='flex flex-col gap-6 w-full'>
                <h1 className='text-left lg:w-[22%] md:w-[32%] w-[45%] font-base font-semibold leading-[3.2rem]'><span className='text-green'>Start</span> your journey with us</h1>
                <p className='text-[1.4rem] lg:w-[45%] md:w-[53%] w-[90%] font-manrope font-normal'>{`Embark on a seamless journey with KASI by registering online. We prioritize simplicity and efficiency, ensuring a smooth start to your experience. Join our platform and unlock the convenience of streamlined services tailored to meet your unique shipping and transportation needs.`}</p>
            </div>
            ...
            <div className='flex lg:flex-row flex-col w-full justify-between gap-5 '>
                ...
                <div className='flex sm:justify-between flex-col basis-[60%]'>
                    <h3 className='font-semibold sm:w-[40%] tracking-wide font-base'>Our <span className='text-green'>Sign-up</span> Process</h3>
                ...
                <div className='flex flex-col gap-4 basis-[40%] border border-[#EDEDED] px-[1.5rem] py-[2rem]'>
                    <p className='font text-[1.6rem]-base font-semibold'>Let's Begin</p>

                    <div className='grid grid-cols-2 font-base gap-x-[1.4rem] gap-y-[2rem]'>
                    ...
                    <button className='bg-green text-white text-center lg:ml-0 ml-8 rounded-[4px] py-2 w-[35%] text-[1.3rem]'>Sign Up</button>
